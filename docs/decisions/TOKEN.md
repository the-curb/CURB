...
| --- | --- | --- |
| Block time | 0.103 s (10,000 blocks in 1,028 s) | Fifteen minutes is about 9,000 blocks; `MAX_BLOCKS_PER_SYNC` of 20,000 covers a tick with margin; the guard's window of 35,000 blocks is about an hour. |
