...
**Status:** **Decided by the product owner, 12 September 2026** — the function, the prices (the US$20.00 cumulative opening minimum, retained as credit balance), the validity and cancellation terms, the governance line, the proceeds split and the order of work. The chain was decided the same day (Robinhood Chain; see *the chain*). The 13 September preparation clarification below makes deployment precede a top-up to that deployment; it does not approve a launch or change prices. The exact proceeds formula, source of prelaunch review funding, launchpad terms and the reviewer's view on credit expiry remain to be resolved. The mechanism's §16 asks for stated conversion and credit terms. The implemented quote has a buffer, **no enforced slippage cap or minimum credit guarantee**, and no fixed exchange rate.
...
**Execution detail still open:** the table specifies priorities and percentages but does not say whether the percentages apply before or after the US$40,000 and US$15,000 priorities. Applying all of them to the same dollar would double-count funds. The [mainnet dossier](../mainnet/PREPARATION.md#economics-and-proceeds) supplies a **PROPOSED**, balanced residual-pool interpretation and examples for the product owner to decide before publishing the launch budget. It does not replace this decision without that recorded choice. Expected token allocation/vesting and launchpad charges must be disclosed from reviewed terms before a sale, then matched against chain evidence when emitted.
...
- **Prelaunch review funding, executable proceeds formula and launchpad verification.** The dossier supplies proposed scenarios and decision fields; no funding, vendor terms, budget interpretation or launch approval is invented.
