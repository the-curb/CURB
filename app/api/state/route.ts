...
export async function GET(): Promise<Response> {
  ...
  const [heartbeatsRead, blocksRead, feedSnapshots, registrar, headSnapshots, driftSnapshots, positionSnaps, evidenceSnaps, creditsRun, creditsCode, storeSchema, tokenSnaps] = await Promise.all([
